...
AddonID = 'plugin.video.playlistloader3'
...
playlistsFile = os.path.join(addonDir, "resources", "playLists.txt")
vDirectoriesFile = os.path.join(addonDir, "resources", "virtual_directoriesLists.txt")
tmpListFile = os.path.join(addonDir, "resources", 'tempList.txt')
