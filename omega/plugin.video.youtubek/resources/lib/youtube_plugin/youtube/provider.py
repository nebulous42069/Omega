...
class Provider(AbstractProvider):
    ...
    def on_channel_playlists(provider, context, re_match):
        ...
        plugin://plugin.video.youtubek/channel/<CHANNEL_ID>/playlists/
    ...
    def on_channel_live(provider,
        ...
        plugin://plugin.video.youtubek/channel/<CHANNEL_ID>/live

        or

        plugin://plugin.video.youtubek/channel/<CHANNEL_ID>/playlist/<PLAYLIST_ID>
    ...
    def on_channel_shorts(provider,
        ...
        plugin://plugin.video.youtubek/channel/<CHANNEL_ID>/shorts
    ...
    def on_playlist(provider, context, re_match):
        ...
        plugin://plugin.video.youtubek/playlist/<PLAYLIST_ID>
    ...
    def on_channel(provider, context, re_match):
        ...
        plugin://plugin.video.youtubek/<ID_TYPE>/<ID>
