...
"""
    ...
    Copyright (C) 2018-2018 plugin.video.youtubek
...
def register_api_keys(addon_id, api_key, client_id, client_secret):
    ...
    addon.xml
    ---
    <import addon="plugin.video.youtubek" version="6.0.0"/>
    ---
    ...
    xbmc.executebuiltin('RunPlugin(plugin://plugin.video.youtubek/channel/UCaBf1a-dpIsw8OxqH4ki2Kg/?addon_id=plugin.video.example)')
