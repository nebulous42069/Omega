...
class source:
    def __init__(self):
        self.results = []
        self.domains = ['yifymovies9.pro']
        self.base_link = 'https://yifymovies9.pro'
        self.search_link = '/?s=%s'
        self.notes = 'Doesnt seem to have tv shows. Sources dont work on my end but kept incase they work for other folks.'
