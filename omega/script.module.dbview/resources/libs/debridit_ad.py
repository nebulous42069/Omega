...
DEBRIDID = {
    ...
    'gearsad': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD_AD, 'gears_ad'),
    ...
    'genocidead': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD_AD, 'genocide_ad'),
    ...
    'otakutad': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD_AD, 'otakut_ad'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.otaku.testing', 'settings.xml'),
        'default'  : 'alldebrid.username',
        'data'     : ['alldebrid.username', 'alldebrid.token', 'alldebrid.enabled'],
