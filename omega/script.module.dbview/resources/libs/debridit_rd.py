...
DEBRIDID = {
    ...
    'gearsrd': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD_RD, 'gears_rd'),
    ...
    'genociderd': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD_RD, 'genocide_rd'),
    ...
    'otakutrd': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD_RD, 'otakut_rd'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.otaku.testing', 'settings.xml'),
        'default'  : 'realdebrid.username',
        'data'     : ['realdebrid.username', 'realdebrid.token', 'realdebrid.client_id', 'realdebrid.secret', 'realdebrid.expiry', 'realdebrid.refresh', 'realdebrid.enabled'],
