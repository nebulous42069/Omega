...
addon = xbmcaddon.Addon("script.module.debridmgr")
setting = addon.getSetting
backup_path = Path(translatePath(setting('backupfolder')))

addon_acctv = xbmcaddon.Addon
addon_acctvObject = addon_acctv('script.module.dbview')
...
class Config:
    ...
    def init_meta(self):
        ...
        self.ADDON_SEP_ICON = joinPath(os.path.join(xbmcaddon.Addon('script.module.dbview').getAddonInfo('path'), 'resources', 'icons'), 'separator.png')
