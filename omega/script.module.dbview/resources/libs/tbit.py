...
TBID = {
    ...
    'gears': {
        ...
        'file'     : os.path.join(CONFIG.TBFOLD, 'gears_tb'),
    ...
    'genocide': {
        ...
        'file'     : os.path.join(CONFIG.TBFOLD, 'genocide_tb'),
