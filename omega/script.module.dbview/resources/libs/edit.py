...
EDID = {
    ...
    'gears': {
        ...
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.gears', 'fanart.png'),
        'file'     : os.path.join(CONFIG.EDFOLD, 'gears_ed'),
    ...
    'genocide': {
        ...
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.genocide', 'fanart.png'),
        'file'     : os.path.join(CONFIG.EDFOLD, 'genocide_ed'),
    ...
    'otaku': {
        ...
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.otaku', 'fanart.png'),
        'file'     : os.path.join(CONFIG.EDFOLD, 'otaku_ed'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.otaku', 'settings.xml'),
        'default'  : 'easydebrid.token',
        'data'     : ['easydebrid.token', 'easydebrid.username', 'easydebrid.enable'],
    ...
    'otakut': {
        ...
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.otaku.testing', 'fanart.png'),
        'file'     : os.path.join(CONFIG.EDFOLD, 'otaku_ed'),
